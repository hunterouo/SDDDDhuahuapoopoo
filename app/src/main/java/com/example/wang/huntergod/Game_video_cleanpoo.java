...
public class Game_video_cleanpoo extends Activity implements SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp2.setLooping(true);
        mp2.start();
        VideoView videoView = (VideoView) findViewById(R.id.videoView002);

        Random rank = new Random();
        int num = rank.nextInt(2) + 1;

        videoView.setVideoPath("storage/emulated/0/Movies/cat1/poopoo/poopoo" + num + ".mp4");
        ...
        videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                mp2.stop();
                Game_video_cleanpoo.this.finish();
            }
        });
