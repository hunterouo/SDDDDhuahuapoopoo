...
public class ActivityVideoPlay extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_video_play);
        choose=(Button)findViewById(R.id.buttonC);
        complete=(Button)findViewById(R.id.buttonD);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if(selectedImageUri!=null){
                VideoView iv = (VideoView)this.findViewById(R.id.videoView02);
...
class UploadPlay {
    ...
    private class VideoUploadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String urlServer = "http://163.13.201.93/video/play_upload.php";
            String lineEnd = "\r\n";
            String twoHyphens = "--";
            String boundary = "*****";
